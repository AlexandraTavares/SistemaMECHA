...
public class Tela_listar extends JFrame {
	...
	public Tela_listar() {
		...
		panel_1.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Listar Clientes",
		...
		btnListar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					modelo.setNumRows(0);
					while (rs.next()) {
						modelo.addRow(new Object[] { rs.getString("id"), rs.getString("nome"), rs.getString("cpf"),
		...
		dbDados = new JTable();
		dbDados.setModel(new DefaultTableModel(new Object[][] { { null, null, null, null, null },
				...
				{ null, null, null, null, null }, { null, null, null, null, null }, { null, null, null, null, null },
				{ null, null, null, null, null }, { null, null, null, null, null }, { null, null, null, null, null }, },
				new String[] { "OS", "NOME", "CPF", "TELEFONE", "ENDERE\u00C7O" }) {
